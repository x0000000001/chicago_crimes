                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.Checklist(
                                            ...
                                            options=[{"label": "2008 crisis", "value": "2008"}, {"label": "Covid crisis", "value": "covid"}],
                                            value=[],
...
@app.callback(
    ...
    [Input("multiline-graph", "figure"), Input("multiline-mode", "value"), Input("multiline-checklist", "value")],
)
